...
export default function Hero(){
    return (
        <section className="min-h-screen bg-[url('/images/header-bg.svg')] bg-no-repeat  px-3 bg-center mt-[7em]">
        <div
        className="rounded-[3em] max-w-6xl mx-auto bg-transparent bg-white bg-opacity-10  flex flex-col gap-5 px-5 md:py-[3em] py-[2em]"
        >
